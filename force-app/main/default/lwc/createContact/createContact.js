...
import fetchLookupData from '@salesforce/apex/CustomSearch.fetchLookupData';
import fetchDefaultRecord from '@salesforce/apex/CustomSearch.fetchDefaultRecord';
...
this.dispatchEvent(oEvent);
    ...
    handleSubmit(){
        ...
        CreateContact({Name:this.Name, Phone:this.Phone, objId: this.AccountId})
        .then(result => {
